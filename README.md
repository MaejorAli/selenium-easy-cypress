# Cypress Automation Project                                                          [![Build Status](https://circleci.com/<gh>/<MaejorAli>/<selenium_easy_cypress>.svg?style=svg)](<https://app.circleci.com/pipelines/github/MaejorAli>)
